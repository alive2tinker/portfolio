<div>
    <div class="flex py-4" x-data="mobileMenu">
        ...
        <div class="w-screen h-screen bg-zinc-900 opacity-25 fixed top-0 bottom-0" @click="menuOpen = !menuOpen" x-show="menuOpen"></div>
            ...
            <div class="flex justify-between">
                ...
                <div class="flex justify-around dark:text-zinc-300" @click="toggleDarkMode">
                    <button class="dark:text-zinc-300">
                        <svg class="dark:text-zinc-300" x-show="!dark" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <div class="flex h-screen">
                <div class="my-auto">
                    <ul class="m-4 space-y-4">
                        ...
                        @endforeach
                        @if(app()->getLocale() == 'ar')
                        <li class="dark:text-zinc-300"><a href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true)}}">English</a></li>
                        @else
                        <li class="dark:text-zinc-300"><a href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true)}}">العربية</a></li>
                        @endif
                    </ul>
